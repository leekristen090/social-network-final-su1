...
//     const reviewer = bookReviews.map((review: any) => {
//         const r = users.find((user: any) => user._id === review.userId);
//         if (!r && review.userId === currentUser?._id) {
//             return {
//                 ...review,
...
//             if (isGoogleBookId(bid)) { // Add this check function
//                 const bookData = await getBookDetails(bid);
//                 setBook(bookData);
//             } else {
//                 // Your existing logic for local books
//                 const localBook = books.find((b: any) => b.googleBooksId === bid);
//                 setBook(localBook);
//             }
//             fetchBookReviews();
//         };
...
//     }, [bid]);
//
//     function isGoogleBookId(id: string | undefined) {
