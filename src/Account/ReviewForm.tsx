...
export default function ReviewForm({show, handleClose, dialogTitle, addReview, setReview}: {
    ...
    return (
        <Modal show={show} onHide={handleClose} id={"sn-review-form"}>
            ...
            <Modal.Body>
                <FormControl id={"sn-review-modal-text"}
            ...
            <Modal.Footer>
                ...
                <Button onClick={() => {addReview(); handleClose();}} className={"sn-bg-tan"} id={"sn-review-add-button"}>
                    Add Review
                </Button>
            </Modal.Footer>
        </Modal>
